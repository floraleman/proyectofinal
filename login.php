    ...
    <body id="page-top">
        ...
        <header class="masthead-login">
            <div class="container d-flex h-100 align-items-center">
              <div class="col-4">
                <div class="text-left">
                    <h1 class="my-0 txt-black mb-4">Ingreso</h1>
                    <form method="post" action="loguearse.php">
                    <form>
                      <input type="text" class="form-control mb-4" name="dni" placeholder="Dni" id="dni">
                      <input type="password" class="form-control mb-4" name="contrasena" placeholder="Contraseña" id="contrasena">
                      <button type="submit" class="btn btn-login btn-block">Ingresar</button>
                      <h5 class="mt-3">No tenés cuenta? <a href="index.php#contacto"> ¡Registrate! </a></h5>     
                    </form>
                </div>
              </div>
